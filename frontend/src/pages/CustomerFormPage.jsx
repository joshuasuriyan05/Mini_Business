            ...
            <div className="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-2 text-slate-300">
                        {isEditMode ? 'Edit an existing customer.' : 'Create a new customer master record.'}
                    </p>
                </div>
            ...
            <Card>
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input name="code" value={form.code} onChange={handleChange} placeholder="C001"className="w-full rounded-md border px-3 py-2 text-white"/>
                        {fieldErrors.code && (
                    ...
                    <div>
                        ...
                        <input name="name" value={form.name} onChange={handleChange} placeholder="ABC Stores" className="w-full rounded-md border px-3 py-2 text-white"/>
                        {fieldErrors.name && (
                            <p className="mt-1 text-sm text-red-500">
                                {fieldErrors.name}
                            </p>
