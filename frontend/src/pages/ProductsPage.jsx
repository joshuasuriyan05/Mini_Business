                ...
                <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                    <div>
                        <motion.div
                            ...
                            <h2 className="text-4xl font-extrabold text-cyan-400 md:text-5xl">
                                Products
                            </h2>
                        </motion.div>
                ...
                <Card>
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-700">
                        <table className="w-full overflow-hidden">
                            <thead>
                                <tr className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-left">
                                ...
                                {products.map((product, index) => (
                                    <motion.tr
                                        ...
                                        whileHover={{
                                            scale: 1.01,
                                            boxShadow:
                                                "0px 0px 20px rgba(34,211,238,0.15)",
                                        }}
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex items-center gap-3">
                                                <motion.div whileHover={{rotate: 10, scale: 1.1}}
                                                    className="rounded-xl bg-slate-700 p-3 text-cyan-400">
                                                    <Package size={18} />
                                                </motion.div>
                                                <div>
                                        ...
                                        <td className="px-6 py-5">
                                            <motion.span whileHover={{ scale: 1.1 }} className={`rounded-full px-4 py-2 text-sm font-semibold ${
                                                    product.stockQty < 50 ? "bg-red-500/20 text-red-400": "bg-green-500/20 text-green-400"}`} >
