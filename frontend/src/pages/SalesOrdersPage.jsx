    ...
    return (
        <div>
            <div className="mb-6 flex items-center justify-between">
                ...
                <Link to="/sales-orders/new" className="rounded-md bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700">
                    + Create Sales Order
                </Link>
            </div>
            <Card>
                                ...
                                {orders.map((order) => (
                                    <tr
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="rounded-md bg-yellow-500 px-3 py-1 text-xs font-bold text-white">
                                                {order.status}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4 text-white">
